...
const Hero: React.FC<HeroProps> = ({ onSearch, isGenerating }) => {
    ...
    <section className="relative min-h-[85vh] flex flex-col justify-center items-center text-center px-4 pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center items-center mb-12">
          <button 
            onClick={() => onSearch("trending events")}
          ...
          <button className="text-gray-900 dark:text-white flex items-center gap-2 font-medium hover:text-gray-600 dark:hover:text-gray-300 transition-colors px-6 py-4">
