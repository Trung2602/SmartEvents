    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/register/verify-email").permitAll()
                        .requestMatchers("/api/account/forgot-password").permitAll()
                        .requestMatchers("/api/account/verify-forgot-password").permitAll()
                        .requestMatchers("/api/account/reset-password").permitAll()
                        .requestMatchers("/api/account/change-password").permitAll()
                        .requestMatchers("/api/account/update-info").permitAll()
